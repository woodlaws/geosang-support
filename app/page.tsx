  ...
  return <>
    ...
    <section className="hero">
      <div className="shell hero-grid">
        <div className="hero-copy"><span className="eyebrow"><span className="pulse" /> 소상공인의 지원사업부터 성장 실행까지</span><h1>지원사업 선정 이후,<br /><em>매출이 시작됩니다</em></h1><p>정부지원사업을 찾고 준비하는 과정부터<br className="desktop-only" /> 선정 이후 홈페이지·콘텐츠·광고·고객 유입까지 함께합니다.</p><div className="button-row"><Link className="button button-primary" href="/programs">내게 맞는 지원사업 찾기 <span aria-hidden="true">→</span></Link><Link className="button button-outline-coral" href="/after-selection#consult">선정 후 마케팅 실행 상담</Link></div><p className="hero-disclaimer">선정 여부는 주관기관의 심사 기준과 판단에 따르며, 선정을 보장하지 않습니다.</p></div>
        <div className="hero-visual" aria-label="소상공인 대표와 마케팅 전문가의 상담 장면"><img src="https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&w=1400&q=85" alt="밝은 사무실에서 노트북을 보며 상담하는 사업자와 전문가" /><div className="hero-float"><span className="float-icon">✓</span><div><strong>선정 후 실행 준비</strong><small>전략 · 제작 · 운영 · 결과보고</small></div></div></div>
      </div>
    </section>
