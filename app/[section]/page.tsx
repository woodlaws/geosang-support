...
import { ContactLandingPage as EnhancedContactPage } from "@/components/ContactLandingPage";
...
export default async function SectionPage({ params }: Props) {
  ...
  return <>{section !== "hope-return" && section !== "diagnosis" && section !== "insights" && section!=="contact" && <Schema section={section} title={title} />}{section === "insights"&&<JsonLd data={[breadcrumbJson([{name:"홈",path:"/"},{name:"자료실",path:"/insights"}]),faqJson(insightFaqs),collectionSchema]}/>} {section === "contact"&&<JsonLd data={[breadcrumbJson([{name:"홈",path:"/"},{name:"상담 신청",path:"/contact"}]),faqJson(contactFaqs),contactSchema]}/>} {section === "cases" && <JsonLd data={faqJson(caseFaqs)} />}{section === "after-selection" && <JsonLd data={[faqJson(afterSelectionFaqs), serviceSchema]} />}{pages[section]}</>;
}
